...
private:
	...
	virtual void setCurrentQueueLength(const unsigned short& value) = 0;
	virtual void setMaxQueueLength(const unsigned short& value) = 0;
public:
	...
	virtual unsigned short getCurrentQueueLength() const = 0;
	virtual unsigned short getMaxQueueLength() const = 0;
